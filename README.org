...
The script now finally correctly interprets events that have already occurred today, as well as events that occur after midnight. For instance, if it is currently 2:20am and the first event in your schedule is "12:30am worked on book", the script will recognize this event as having already occurred. Similarly, if an event is listed as "12:30am", it will be interpreted as occurring after midnight on the current day, not the next day.
